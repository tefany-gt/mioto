...
const AuthScreen: React.FC<AuthScreenProps> = ({ onClose, initialView = 'login', initialType = 'motorista' }) => {
  ...
  return (
    <div className="fixed inset-0 z-[70] bg-black/50 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4">
      <div className="w-full max-w-[95%] sm:max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden relative animate-in fade-in zoom-in duration-300 flex flex-col max-h-[95vh] sm:max-h-[90vh]">

...
import { LogOut, User as UserIcon, MapPin, Car, Mail, ShieldCheck, Phone, FileText, Camera, Fingerprint, Star, Briefcase, Edit2, Save, X, Trash2, PlusCircle, Download, Monitor, Clock, CalendarDays, Power, Check, ChevronRight } from 'lucide-react';
